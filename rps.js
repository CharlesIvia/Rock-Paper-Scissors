...
function checkWinner() {
  if (aiOption === ninjaOption) {
    ...
    (aiOption === "Rock" && ninjaOption === "Scissors") ||
    (aiOption === "Scissors" && ninjaOption === "Paper") ||
    (aiOption === "Paper" && ninjaOption === "Rock")
  ) {
    return "ai";
  } else if (
    (ninjaOption === "Rock" && aiOption === "Scissors") ||
    (ninjaOption === "Scissors" && aiOption === "Paper") ||
    (ninjaOption === "Paper" && aiOption === "Rock")
  ) {
    return "ninja";
  }
}
